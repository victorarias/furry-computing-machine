...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.iter_count += 1
            self.epsilon = math.exp(-0.02*self.iter_count)
    ...
    def createQ(self, state):
        ...
        if state not in self.Q:
            ...
            for valid_action in self.valid_actions:
                state_action_qs[valid_action] = 0.0

            self.Q[state] = state_action_qs
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            if random.random() < self.epsilon:
                ...
                actions_with_max_value = [k for k, v in self.Q[state].iteritems() if v == max_value]
